...
void GpsPlugin::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
    ...
    gzwarn << "[sdf path] Path of sdf file" << _sdf->FilePath() << "\n";
    ...
    else
    {
        ...
        gzwarn << "[gazebo_gps_plugin]: " + rootModelName + "::" + parentSensorModelName + " using gps topic \"" << parentSensorModelName << "\"\n";
    }
    ...
    updateWorldConnection_ = event::Events::ConnectWorldUpdateBegin(boost::bind(&GpsPlugin::OnWorldUpdate, this, _1));
